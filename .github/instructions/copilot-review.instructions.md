---
description: "Review priorities for bro-frontend"
applyTo: "**"
---

# Review priorities

Review the requested change against repository evidence and `.github/workflows/build-and-deploy.yaml`.
...
For interface changes, check keyboard access, focus, labels and Norwegian user-facing text.
