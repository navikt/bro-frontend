...
export const flervalgSpm3RadioConfig = defineVariantConfig({
  formFields: [
    {
    ...
    {
      fieldId: "naarTilbakeTilJobbenMerEnnSeksManederGrunnRadioFlervalg",
      isRequired: true,
      conditionallyAddIf: (formValues) =>
  ...
  validationSchema: z.object({
    ...
    naarTilbakeTilJobbenMerEnnSeksManederGrunnRadioFlervalg:
      fieldSchemas.naarTilbakeTilJobbenMerEnnSeksManederGrunnRadioFlervalg,
