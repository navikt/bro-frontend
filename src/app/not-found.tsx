      ...
      <Box paddingBlock="20 16" data-aksel-template="404-golden-path">
        <VStack gap="space-40">
          <Alert variant="warning">
            <BodyShort>
              Dette er en veldig enkel mal som er hardkoded i Golden Path artikkelen, og kan muligens være utdatert. For
              å se den mest oppdaterte versjonen av malene til aksel kan du besøke{' '}
