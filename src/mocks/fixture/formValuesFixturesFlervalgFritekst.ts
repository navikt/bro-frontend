...
export const formValues1a2a3a: FormValues<"FLERVALG_FRITEKST_V1"> = {
...
export const formValues1b: FormValues<"FLERVALG_FRITEKST_V1"> = {
...
export const formValues1bNoText: FormValues<"FLERVALG_FRITEKST_V1"> = {
  tilbakeTilJobbenHvorSannsynligFlervalg: "1b",
  tilbakeTilJobbenLiteSannsynligBegrunnelse: "",
  tilbakeTilJobbenUsikkerBegrunnelse: "",
  arbeidsgiverHvordanErSamarbeidFlervalg: "2a",
...
export const formValues1a2a3aButTextFor1b: FormValues<"FLERVALG_FRITEKST_V1"> =
  {
    tilbakeTilJobbenHvorSannsynligFlervalg: "1a",
    tilbakeTilJobbenLiteSannsynligBegrunnelse:
...
export const formValues1cTextFor1bAnd1c: FormValues<"FLERVALG_FRITEKST_V1"> = {
...
export const formValues1c2b3bWithText: FormValues<"FLERVALG_FRITEKST_V1"> = {
  tilbakeTilJobbenHvorSannsynligFlervalg: "1c",
  tilbakeTilJobbenLiteSannsynligBegrunnelse: "",
