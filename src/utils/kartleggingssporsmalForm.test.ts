...
import { mapAppFormToSnapshot, mapFormSnapshotToSummaryItems } from '@/utils/kartleggingssporsmalForm'
import { kartleggingssporsmalFormFixture, fieldSnapshotsFixture } from '@/mocks/fixture/form'

describe('kartleggingssporsmalForm utils', () => {
  describe('mapAppFormToSnapshot', () => {
    it('should map form values to fieldSnapshots', () => {
      const snapshots = mapAppFormToSnapshot({ values: kartleggingssporsmalFormFixture })
      ...
      expect(snapshots).toEqual([
        ...
        },
        {
          ...
          fieldType: 'RADIO_GROUP',
          options: [
            { optionId: '2a', optionLabel: 'Jeg opplever samarbeidet og relasjonen som god', wasSelected: true },
            { optionId: '2b', optionLabel: 'Jeg opplever samarbeidet og relasjonen som dårlig', wasSelected: false },
          ],
        },
        {
          ...
          fieldType: 'RADIO_GROUP',
          options: [
            { optionId: '3a', optionLabel: 'Mindre enn seks måneder', wasSelected: true },
            { optionId: '3b', optionLabel: 'Mer enn seks måneder', wasSelected: false },
          ],
        },
      ])
    })
